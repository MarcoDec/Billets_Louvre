        ...
        function renderView(inc){
            if(elementVisible()){
                ...
                if(today>=currentView.start&&today<currentView.end){
                    ...
                    header.enableButton('today')}ignoreWindowResize--;
                        ...
                        $.each(
                            ...
                            function(j,buttonName){
                                if(buttonName=='title'){
                                    ...
                                    if(buttonClick){
                                        var icon=options.theme?smartProperty(
                                            options.buttonIcons,
                                            buttonName
                                        ):null;
                                        var text=smartProperty(
                                            options.buttonText,
                                            buttonName);
